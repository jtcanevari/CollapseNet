...
## Collapse at facility-level using path-length 3 {.tabset .tabset-pills}

### Logan's version

Begin with the central staff-staff edges and table join staff-facility edges onto either side.
